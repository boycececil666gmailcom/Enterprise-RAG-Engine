---
title: Material Type
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/material-type-reference.html
---
...
The vertex attributes that the shader expects to find in the vertex buffer of the models that use materials of this material type. For example, this includes the position, normal, and texture coordinates of the vertices.
