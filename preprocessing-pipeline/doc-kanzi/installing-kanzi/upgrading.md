---
title: Upgrading Kanzi
source: https://docs.kanzi.com/4.1.0/en/installing-kanzi/upgrading.html
---
...
Install the newer version of Kanzi. See Installing Kanzi.
2.
...
In the License Manager select Release this license and click Next.
3.

Write down the product key shown next to the Product key field in the License Manager and click Release.
4.
...
Select either License file or Product key, depending on the type of license you have available, and click Next.
7.

Activate the license type you selected in the previous step:
