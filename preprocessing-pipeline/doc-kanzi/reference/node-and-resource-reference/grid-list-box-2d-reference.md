---
title: Grid List Box 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/grid-list-box-2d-reference.html
---

# Grid List Box 2D

## Grid List Box 2D properties
...
Yes |
## Grid List Box 2D available properties
