---
title: List Box Item Container 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/list-box-item-container-2d-reference.html
---

# List Box Item Container 2D

## List Box Item Container 2D properties
...
Yes |
## List Box Item Container 2D available properties
