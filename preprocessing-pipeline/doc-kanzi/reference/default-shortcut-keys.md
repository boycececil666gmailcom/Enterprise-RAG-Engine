...
source: https://docs.kanzi.com/4.1.0/en/reference/default-shortcut-keys.html
---
...
SetCameraFocusToSelectedInGizmo |
...
Scale more than one selected keyframe. Left mouse button scales the selected keyframes along x and y axes. Right mouse button scales the selected keyframes along the x axis. Middle mouse button scales the selected keyframes along the y axis. |
