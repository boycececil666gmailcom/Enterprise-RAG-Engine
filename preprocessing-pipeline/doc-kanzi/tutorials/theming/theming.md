---
title: Tutorial: Theme your application
source: https://docs.kanzi.com/4.1.0/en/tutorials/theming/theming.html
---
...
- Create different appearances of the same application. To learn how to do this, you create a car cluster with these themes:
  ...
  - The Classic theme contains circular speed and RPM gauges with the values for both shown in the center of the gauge.
  - The Modern theme contains staircase speed and RPM gauges where the values for both move up as the values increase and down as values decrease.

- Use a single Kanzi Studio project for more than one variant of your product. To learn how to do this, you create a car cluster for these car variants:
