---
title: Step 6 - Deploy your application
source: https://docs.kanzi.com/4.1.0/en/tutorials/first/step-6.html
---
...
Select File > Export > Export as KZB Player for Windows.
2.

Click Yes when asked whether you want Kanzi Studio to preprocess images.
3.
...
To run the application, open the application exe file.
...
In this tutorial you created Kanzi application using only Kanzi Studio. Now you can:

- Complete other tutorials
- Explore Kanzi features
- Learn how to deploy your Kanzi applications to different platforms
