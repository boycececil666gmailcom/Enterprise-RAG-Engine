---
title: Using the Asset Toolkit assets
source: https://docs.kanzi.com/4.1.0/en/working-with/asset-toolkit/using-the-asset-toolkit-assets.html
---
...
In the Asset Packages window select the Asset Toolkit asset source.
...
From the Asset Packages, drag the item that you want to use in your project to a node in the Node Tree, to the Prefabs, or to the Preview. The cursor will indicate whether you can drop the item in that location or not.
...
From the Asset Toolkit drag the material that you want to use in your project to a node in the Preview, or a node in the Node Tree.

For example, to use a paint material to turn the sunroof on the car to a metal, drag that material to either:
