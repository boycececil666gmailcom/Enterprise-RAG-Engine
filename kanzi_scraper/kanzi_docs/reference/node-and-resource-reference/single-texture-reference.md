...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/single-texture-reference.html
---

# Single Texture

## Single Texture properties
...
No |
## Single Texture available properties
