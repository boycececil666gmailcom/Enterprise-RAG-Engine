---
title: Progressive Rendering Viewport 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/progressive-rendering-viewport-2d-reference.html
---
