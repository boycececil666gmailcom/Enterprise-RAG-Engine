...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/angle-trajectory-reference.html
---

# Angle Trajectory

## Angle Trajectory properties
...
No |
## Angle Trajectory available properties
