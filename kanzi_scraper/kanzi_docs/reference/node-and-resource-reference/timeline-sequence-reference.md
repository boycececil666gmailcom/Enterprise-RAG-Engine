...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/timeline-sequence-reference.html
---
...
No |
## Timeline Sequence available properties
