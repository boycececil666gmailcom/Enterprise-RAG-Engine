---
title: Kanzi 4.1.0
source: https://docs.kanzi.com/4.1.0/en/overview.html
---
...
## Get started with Kanzi
  [](installing-kanzi/license-management/license-management.html)

Activate your Kanzi Studio license   [](tutorials/getting-started/getting-started.html)

Start by learning about Kanzi Studio   [](tutorials/tutorials.html)

Complete Kanzi tutorials   [](working-with/working-with.html)

Get familiar with Kanzi features   [](best-practices/best-practices.html)

Kanzi best practices   [](kanzi-fundamentals/kanzi-fundamentals.html)

Learn about Kanzi principles
