---
title: Using circle trajectories
source: https://docs.kanzi.com/4.1.0/en/working-with/trajectories/using-circle-trajectories.html
---
...
In the Library press Alt and right-click Trajectories and select Circle Trajectory.
2.
