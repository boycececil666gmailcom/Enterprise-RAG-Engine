---
title: Using angle trajectories
source: https://docs.kanzi.com/4.1.0/en/working-with/trajectories/using-angle-trajectories.html
---
...
In the Library press Alt and right-click Trajectories and select Angle Trajectory.
2.
...
For example:
  ...
  - Angle to set the size of the angle in degrees.
