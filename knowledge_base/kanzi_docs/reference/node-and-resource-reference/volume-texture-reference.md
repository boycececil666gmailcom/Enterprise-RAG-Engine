...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/volume-texture-reference.html
---
...
No |
## Volume Texture available properties
