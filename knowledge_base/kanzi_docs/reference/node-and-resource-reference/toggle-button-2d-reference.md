---
title: Toggle Button 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/toggle-button-2d-reference.html
---

# Toggle Button 2D

## Toggle Button 2D properties
...
Yes |
## Toggle Button 2D available properties
