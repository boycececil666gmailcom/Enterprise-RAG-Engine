---
title: Flow Layout 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/flow-layout-2d-reference.html
---

# Flow Layout 2D

## Flow Layout 2D properties
...
No |
## Flow Layout 2D available properties
