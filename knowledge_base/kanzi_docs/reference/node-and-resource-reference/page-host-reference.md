---
title: Page Host (deprecated)
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/page-host-reference.html
---

# Page Host (deprecated)

## Page Host (deprecated) properties
...
Yes |
## Page Host (deprecated) available properties
