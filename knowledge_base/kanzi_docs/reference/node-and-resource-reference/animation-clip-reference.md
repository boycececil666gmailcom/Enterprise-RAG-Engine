...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/animation-clip-reference.html
---
...
No |
## Animation Clip available properties
