---
title: Parallel Activity Host 3D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/parallel-activity-host-3d-reference.html
---

# Parallel Activity Host 3D

## Parallel Activity Host 3D properties
...
Yes |
## Parallel Activity Host 3D available properties
