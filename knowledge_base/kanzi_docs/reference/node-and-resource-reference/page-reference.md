...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/page-reference.html
---

# Page (deprecated)

## Page (deprecated) properties
...
Yes |
## Page (deprecated) available properties
