---
title: Toggle Button 3D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/toggle-button-3d-reference.html
---

# Toggle Button 3D

## Toggle Button 3D properties
...
No |
## Toggle Button 3D available properties
