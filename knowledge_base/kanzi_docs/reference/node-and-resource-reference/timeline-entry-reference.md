...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/timeline-entry-reference.html
---

# Timeline Entry

## Timeline Entry properties
...
No |
## Timeline Entry available properties
