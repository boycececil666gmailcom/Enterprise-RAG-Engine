...
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/cubemap-texture-reference.html
---

# Cubemap Texture

## Cubemap Texture properties
...
No |
## Cubemap Texture available properties
