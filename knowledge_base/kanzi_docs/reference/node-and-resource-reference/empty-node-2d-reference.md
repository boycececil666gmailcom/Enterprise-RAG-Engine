---
title: Empty Node 2D
source: https://docs.kanzi.com/4.1.0/en/reference/node-and-resource-reference/empty-node-2d-reference.html
---

# Empty Node 2D

## Empty Node 2D properties
...
No |
## Empty Node 2D available properties
