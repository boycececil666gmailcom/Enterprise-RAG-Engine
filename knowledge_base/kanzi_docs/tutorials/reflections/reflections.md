---
title: Tutorial: Create reflections
source: https://docs.kanzi.com/4.1.0/en/tutorials/reflections/reflections.html
---

# Tutorial: Create reflections

In this tutorial you learn how to use the Instantiator node, tags, filters, and render passes to create reflections in Kanzi Studio.
